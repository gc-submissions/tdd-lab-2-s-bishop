...
describe("formatCurrency", () => {
  test("Given the amount 0, it returns '$0.00'.", () => {
    ...
    test("Given the amount 34.86, it returns '$34.86'", () => {
      expect(formatCurrency(34.86)).toBe("$34.86");
    })

    test("Given the amount -0.0155, it returns '-$0.02'", () => {
      expect(formatCurrency(-0.0155)).toBe("-$0.02");
    })
});
